...
type: Documentation
audience: end-user
user-guide-title: 자산 계산 서비스 가이드
user-guide-description: 이 설명서 [!DNL Asset Compute Service] 는 사용자 지정 코드를 개발, 관리, 배포 및 해결하는 방법과 같은 질문을 다룹니다.
breadcrumb-title: 자산 계산 서비스 가이드
breadcrumb-url: /docs/asset-compute/using/home.html
solution-title: AEM Assets
solution-hub-url: https://docs.adobe.com/content/help/ko-KR/experience-manager-cloud-service/assets/home.html
...
# 자산 계산 서비스 사용 안내서 {#using}

+ [자산 계산 서비스 사용 안내서](home.md)
+ [개요](introduction.md)
+ [릴리스 노트](release-notes.md)
+ [지원되는 파일 형식](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/assets/file-format-support.html)
...
+ 자산 계산 서비스 확장 {#extend}
   ...
   + [Cloud Service으로 Experience Manager 통합 및 사용](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/assets/asset-microservices-overview.html)
